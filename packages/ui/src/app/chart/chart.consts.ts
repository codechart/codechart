...
export const MatchDistance = {
  betweenMatches: () =>
    ChartConsts.matchDistance.betweenMatches * ChartConsts.gridBaseSize,
  toPreviousMatch: () =>
...
export const CcItemStyles = {
  ...
  baseLink: {
    ...
    smooth: false,
    color: { inherit: false },
    font: { color: 'black', background: 'white', strokeWidth: 0, size: 30 },
  ...
  gotoNode: {
    image: '/assets/nodes/push-pin.svg',
    size: 20,
    shape: 'circularImage',
  },
  ...
  fileLink: {
    ...
    width: 0.2,
    hidden: true,
    d: { type: NodeTypes.ofFile },
  },
  suspectedSameMatchLink: {
    dashes: [2, 12],
    d: { type: 'suspectedSameMatch' },
  },
  nodesTypes: [
    {
      name: 'remark',
  ...
  numberNode: {
    ...
    color: 'green',
    fixed: false,
    font: { align: 'center', size: 40, color: 'white' },
  },
  numberLink: { length: 200 },
  resultNode: {
    color: { background: '#f0f8ff', border: '#000000' },
    shape: 'box',
  },
  ...
  splitNode: {
    ...
    color: { background: '#9B9B9B' },
  },
  failedSyncNode: {
    color: { background: 'red' },
    shape: 'circularImage',
    image: '/assets/nodes/warn.svg',
    font: {
      background: 'white',
      size: 40,
      align: 'left',
